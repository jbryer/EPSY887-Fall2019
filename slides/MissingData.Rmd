...
* <font size='3'>`NonD` - Nondreaming sleep (hours / day)</font>
...
* <font size='3'>`Pred` - Predation index: 1 = minimum (least likely to be preyed upon) to 5 = maximum (most likely to be preyed upon)</font>
